...
const CriarConta = (props) => {
    ...
    const [booleanRepeat, setBooleanRepeat] = useState(false)
    ...
    if (repeatPassword == senha) { // englobar dentro de cadastrarNewUser 
        ...
        setBooleanRepeat(false)
    } else {
        console.log('repeatPassword != senha')
        setBooleanRepeat(true) 
    }
    ...
    return (  
         ...
         <View style={styles.container}>
                <View style={styles.main}>
                    ...
                    <Text style={styles.aviso}>{booleanRepeat ? 'Senha não confere!' : ''}</Text>
