...
const EditarVacina = (props) => {
    const [latitudeRedux, setLatitudeRedux] = useState(useSelector((state) => state.vacina.latitude))
    setLatitudeRedux(useSelector((state) => state.vacina.latitude))
    console.log('UseEffect do Maps em EditarVacinas -- latitudeRedux -- ')
    console.log(latitudeRedux)
    useEffect(() => {
        
        Geolocation.watchPosition((position) => {
            
            setLatitude(position.coords.latitude) // aqui vira do redux
