...
const NovaVacina = (props) => {
    ...
    let str = "11/10/2022"//   09/10/2022 
    var dataProxima = new Date(str.split('/').reverse().join('/'))
    var newDate = new Date() 

    if(dataProxima > newDate) {     
        console.log('dataProxima eh maior que a  atual ')
    } else {
        console.log(`error hah ${dataProxima.getDate().toLocaleString('pt-br')}`)
    }
    if(newDate > dataProxima) {
        console.log(`a data atual eh maior q DATAPROXIMA`)
    }
