...
const userDb = 'usuarios/' + email + '/MyVacinas';
    const q = query(collection(db, userDb)
...
const SignIn = (props) => {
    ...
    // vou disparar a acao do "reducerSetLogin"
    ...
    const authUser = () => {
        ...
        .then((userCredential) => {
            ...
            // dispatch vai disparar o reducerSetLogin (action)
            dispatch(reducerSetLogin({email: email, password: senha}))
            //com essa unica linha, eu consigo armazenar dados dentro do estado global login, que esta dentro de store.j 
                ...
                >
                    <LinearGradient style={styles.imagemBackgroundColor} 
                            ...
                            <View style={styles.dados}>
                                ...
                                <Text style={styles.txtWarning}>{labelVerificaUser ? null : 'E-mail e/ou senha inválidos.'} </Text>
                                {
                                    isAuthenticating ? 
                                    <View style={styles.autenticando}>
                                        <View>{isAuthenticating && labelVerificaUser ? <ActivityIndicator size="small" color="#419ED7"/> : null}</View>
                                        <Text style={styles.txtAutenticando}>{isAuthenticating && labelVerificaUser ? 'Autenticando . . .' : null }</Text>
                                    </View>
                                    : null
                                }
                                </View>
