                    ...
                    <LinearGradient style={styles.imagemBackgroundColor} 
                            ...
                            <View style={styles.dados}>
                                ...
                                <View style={styles.autenticando}>
                                    <View>{isAuthenticating && labelVerificaUser ? <ActivityIndicator size={"large"} color="#419ED7"/> :  <ActivityIndicator size={"large"} />}</View>
                                    <Text style={styles.txtAutenticando}>Autenticando . . .</Text>
                                </View>
                                </View>
