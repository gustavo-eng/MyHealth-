...
const EditarVacina = (props) => {
    ...
    const [proximaData, setProximaData] = useState(props.route.params.dados.proximaData)
    ...
    const {dose, proximaData, vacina} = props.route.params.dados
    return (
        <View style={styles.container}>
            ...
            <View style={styles.dataVacina}>
                ...
                <TouchableOpacity style={styles.btnCalender} onPress={() => setOpen(true)} >
                    ...
                    <Text style={styles.inputDados}> {proximaData ? proximaData : proximaData}</Text>
                    <Image
                            style={styles.icone}
                            source={require('../images/calender.png')}
                    />
