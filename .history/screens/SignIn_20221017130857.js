                    ...
                    <LinearGradient style={styles.imagemBackgroundColor} 
                            ...
                            <View style={styles.dados}>
                                ...
                                <View style={styles.autenticando}>
                                    <Text style={styles.txtWarning}>{isAuthenticating && labelVerificaUser ? <ActivityIndicator size={"large"} color="rgba(65, 158, 215, 1)"/> :  <ActivityIndicator size={"large"} />}</Text>
                                    <Text>testando</Text>
                                </View>
                                </View>
