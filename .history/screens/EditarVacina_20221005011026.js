    ...
    return (
        <View style={styles.container}>
            ...
            { openProxima ? (
                ...
                //is24hourSource="device"
                onConfirm={(dateProxima) => {
                  setOpen(false)
                  setDateProxima(dateProxima)
                  setProxima((dateProxima.getDate()+ '/' + (dateProxima.getMonth() + 1) + '/' + dateProxima.getFullYear()))
            ...
            <View style={styles.caixaDeDados}>
                ...
                <TextInput style={styles.inputDados}>oq</TextInput>
            </View>
            ...
            <View style={styles.dataVacina}>
                ...
                <TouchableOpacity style={styles.btnCalender} onPress={() => setOpenProxima(true)}>
                    <Text style={styles.inputDados}>{proxima}</Text>
                    <Image
                            style={styles.icone}
                            source={require('../images/calender.png')}
                    />
