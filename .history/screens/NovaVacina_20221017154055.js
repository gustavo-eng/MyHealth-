...
const NovaVacina = (props) => {
    ...
    const alterarLista = () => {
        //listaVacinas[listaVacinas.length + 1 ].id = 4
        listaVacinas[listaVacinas.length + 1 ].vacina = 'Vacina teste'
        listaVacinas[listaVacinas.length + 1 ].data = '10/02/2023'
        listaVacinas[listaVacinas.length + 1 ].dose = 2
        listaVacinas[listaVacinas.length + 1 ].urlImage = 'http://'
        listaVacinas[listaVacinas.length + 1 ].proximaVacina = '13/05/2022'
    ...
    return (
        <View style={styles.container}>
           ...
           <View style={styles.caixaDeDados}>
                ...
                <TextInput style={styles.inputDados} placeholder="Nome da vacina" /> 
           </View>
           ...
           <View style= {styles.containerCadastrar} >
                <TouchableOpacity style= {styles.cadastrar} onPress={alterarLista}>
