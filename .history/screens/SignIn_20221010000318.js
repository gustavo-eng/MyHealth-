...
import googleFonts from 'https://fonts.googleapis.com/css2?family=Averia+Libre:wght@300&family=Inter&family=Lexend:wght@300;500;600&family=Roboto:ital,wght@0,700;1,700&display=swap'
    ...
    return (
        <View style={styles.container}>
                <ImageBackground
                    ...
                    style={styles.imagem}
                >
                    <View style={styles.imagemBackgroundColor}>
