...
const NovaVacina = (props) => {
    ...
    vetor = []
    const alterarLista = () => { // isso aqui alterar e eh pra ir la para a vacina editar vacinas, isso aqui funciona  listaVacinas[listaVacinas.length - 1].id = 1000, 
        ...
        listaVacinas.push({id :listaVacinas.length + 1 ,vacina : newVacina,data : data ,dose: selected, urlImage: 'http://',proximaVacina :proximaData })
