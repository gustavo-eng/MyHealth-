        ...
        <View style={styles.container}>
            ...
            { openP ? (
                ...
                onConfirm={(dateP) => {
                  setOpen(false)
                  setDateP(dateP)
                  setDataP((dateP.getDate()+ '/' + (dateP.getMonth() + 1) + '/' + dateP.getFullYear()))
            ...
            <View style={styles.dataVacina}>
                ...
                <TouchableOpacity style={styles.btnCalender} onPress={() => setOpenP(true)}>
               
                    <Text style={styles.inputDados}>{dataP}</Text>
                    <Image
                            style={styles.icone}
                            source={require('../images/calender.png')}
                    />
