    ...
    return (  
         ...
         <View style={styles.container}>
                ...
                <View style={styles.main}>
                    ...
                    <TextInput style={styles.inputsEmail}>{email}</TextInput>
                    <TextInput style={styles.inputsEmail}>{senha}</TextInput> 
                    <TextInput style={styles.inputsRepetirSenha}>repetir senha </TextInput> 
               </View>
