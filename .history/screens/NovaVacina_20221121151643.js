...
const NovaVacina = (props) => {
    ...
    useEffect(() => {
        Geolocation.watchPosition // monitora o tempo todo a posicao 
    }, [])
    ...
    return ( 
        <View style={styles.container}>
           ...
           <TouchableOpacity style= {styles.containerLocation} onPress={showOnGoogleMaps}>
                <View >
                    <Text style={{color: 'white'}}>Latitude : {latitude} -- Longitude: {longitude} </Text>     
                </View>
            </TouchableOpacity> 
