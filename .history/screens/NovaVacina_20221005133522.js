...
const NovaVacina = (props) => {
    ...
    if(listaVacinas[1].proximaVacina < d1.getDate().toLocaleString('pt-br') ){
        console.log(` ${listaVacinas[1].proximaVacina} e menor que ${d1.getDate().toLocaleString('pt-br')}`)
    } else {
        console.log(` ${listaVacinas[1].proximaVacina} e MAIOR que ${d1.getDate().toLocaleString('pt-br')}`)
    } 
    // Date picker 
