...
const NovaVacina = (props) => {
    ...
    if(listaVacinas[0].proximaVacina < d1.getDate().toLocaleString('pt-br') ){
        console.log(` ${listaVacinas[0].proximaVacina} e menor que ${d1.getDate().toLocaleString('pt-br')}`)
    } else {
        console.log(` ${listaVacinas[0].proximaVacina} e MAIOR que ${d1.getDate().toLocaleString('pt-br')}`)
    } 
    // Date picker 
