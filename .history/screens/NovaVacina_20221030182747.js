...
const NovaVacina = (props) => {
    ...
    vetor = []
    const novaVacina = () => { // isso aqui alterar e eh pra ir la para a vacina editar vacinas, isso aqui fu nciona  listaVacinas[listaVacinas.length - 1].id = 1000, 

        console.log('-------- DENTRO DE NOVA VACINA --------')
        console.log('--------------------- TAMANHO DA LISTA --------------------- --> ') 
        console.log(listaVacinas.length)
        //pegar o maior id da lista e incrementar mais 1 = + 1 
        listaVacinas.push({id :listaVacinas.length,vacina : newVacina,data : data ,dose: selected + 1, urlImage: 'http://',proximaVacina :proximaData })
