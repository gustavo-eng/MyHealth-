...
const EditarVacina = (props) => {
    ...
    const   [nomeVacina, setNomeVacina] = useState('ok')
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.caixaDeDados}>
                ...
                <TextInput style={styles.inputDados} value={nomeVacina} onChangeText={setNomeVacina}>{nomeVacina? nomeVacina : props.route.params.dados.vacina}</TextInput>
            </View>
