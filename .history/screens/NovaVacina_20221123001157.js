...
const NovaVacina = (props) => {
    ...
    useEffect( () => {
        ...
        Geolocation.watchPosition((position) => {
            ...
            dispatch(reducerSetVacina({longitude: position.coords.longitude, latitude:position.coords.latitude}))
    ...
    const latitudeRedux = useSelector((state) => state.vacina.latitude)
