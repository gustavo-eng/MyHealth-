...
const EditarVacina = (props) => {
    ...
    const onChange = (event, selectedDate) => {
        ...
        let fDate = (tempDate.getDate() + '/' + (tempDate.getMonth() + 1) + '/' + tempDate.getFullYear()).toString(); // pega a data  
        let fTime = 'Hours' + tempDate.getHours() + '| Minutos' + tempDate.getMinutes(); // pega horas, podera ser excluido 
        setText(`${fDate} \n ${fTime}`)
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.dataVacina}>
                ...
                <TouchableOpacity style={styles.btnCalender} onPress={() => showMode('date')}>
                    <Text style={styles.inputDados}>{text}</Text> {/*HERE */}
                    <Image
                            style={styles.icone}
            ...
            <View style={styles.caixaDeDados}>
                ...
                <TextInput style={styles.inputDados}>{text}</TextInput>
            </View>
