...
const NovaVacina = (props) => {
    ...
    const alterarLista = () => {
        listaVacinas[listaVacinas.length  ].id = 4
        listaVacinas[listaVacinas.length  ].vacina = 'Vacina teste'
        listaVacinas[listaVacinas.length  ].data = '10/02/2023'
        listaVacinas[listaVacinas.length  ].dose = 2
        listaVacinas[listaVacinas.length ].urlImage = 'http://'
        listaVacinas[listaVacinas.length  ].proximaVacina = '13/05/2022'
