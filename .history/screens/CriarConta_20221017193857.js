    ...
    return (  
         ...
         <View style={styles.container}>
                ...
                <View style={styles.main}>
                    ...
                    <Text style={styles.aviso}>{booleanRepeatDiferente ? `Senha não confere!`: null }</Text>
                ...
                <View style={styles.main}>  
                    ...
                    <TouchableOpacity style={styles.inputsData} onPress={() => setOpen(true)}>
                        <Text style={styles.txtDataNascimento}>{data}</Text>
                        <Image
                            style={styles.icone}
...
//<TextInput style={styles.inputsData}/> 
