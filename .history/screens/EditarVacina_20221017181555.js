...
const EditarVacina = (props) => {
    ...
    const [data, setData] = useState(props.route.params.dados.data)
    const [proximaData, setProximaData] = useState(props.route.params.dados.proximaVacina)
    ...
    const   [nomeVacina, setNomeVacina] = useState(props.route.params.dados.vacina)
    ...
    const backHome = () => { // fase de teste para navegacao
        ...
        listaVacinas[props.route.params.dados.id].proximaVacina = 
    }
    
    // MODAL DE CONFIRMACAO
    const confirma = () => { // funcao EXCLUIR ITEM DA LISTA -----------------------
        ...
        console.log(typeof(props.route.params.dados.id))
    ...
    // props.route.params.dados.vacina
    return (
