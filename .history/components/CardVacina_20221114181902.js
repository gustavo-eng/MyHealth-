...
const CardVacina = (props) => { 
    ...
    const editarVacinas = (id) => {  
        dispatch(reducerSetVacina({vacina: item.vacina, dose: item.dose, urlImage : item.urlImage, data: item.data, proximaData: item.proximaData}))
        props.navigation.navigate('EditarVacina', { setAlterou, alterou,id: id})
    ...
    return (
        ...
        <TouchableOpacity  onPress={() => editarVacinas(item.id)}>
